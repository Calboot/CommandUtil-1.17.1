...
import com.calboot.cmdutil.commands.CommandBuilders;
...
public final class CommandUtil implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, dedicated) -> dispatcher.register(CommandBuilders.KILL_ITEM));
    }
}
